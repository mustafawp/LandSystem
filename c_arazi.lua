...
Genislik,Uzunluk = 474,446
X = (sGenislik/2) - (Genislik/2)
Y = (sUzunluk/2) - (Uzunluk/2)

mainwindow = guiCreateWindow(X, Y, Genislik, Uzunluk, "Arazi Bilgi & Satış", false)
guiWindowSetSizable(mainwindow, false)
guiSetVisible(mainwindow,false)

araziidlbl = guiCreateLabel(25, 84, 108, 19, "● Arazi ID:", false,mainwindow)
local font0_Font13 = guiCreateFont("Font13.ttf", 11)
guiSetFont(araziidlbl, font0_Font13)
cizgi1 = guiCreateLabel(10, 27, 454, 19, "——————————————————————————————————————————————————————————————————————————————————————", false, mainwindow)
guiSetFont(cizgi1, font0_Font13)
bilgi1 = guiCreateLabel(188, 46, 120, 19, "● Arazi Bilgileri ✔ ●", false, mainwindow)
guiSetFont(bilgi1, font0_Font13)
cizgi2 = guiCreateLabel(10, 65, 454, 19, "——————————————————————————————————————————————————————————————————————————————————————", false, mainwindow)
guiSetFont(cizgi2, font0_Font13)
arazisahiplbl = guiCreateLabel(25, 107, 206, 19, "● Arazi Sahibi:", false, mainwindow)
guiSetFont(arazisahiplbl, font0_Font13)
araziturlbl = guiCreateLabel(25, 130, 206, 19, "● Arazi Türü:", false, mainwindow)
guiSetFont(araziturlbl, font0_Font13)
arazirenklbl = guiCreateLabel(25, 155, 206, 19, "● Arazi Rengi:", false, mainwindow)
guiSetFont(arazirenklbl, font0_Font13)
arazidurumlbl = guiCreateLabel(25, 181, 331, 19, "● Arazi Durumu:", false, mainwindow)
guiSetFont(arazidurumlbl, font0_Font13)
araziilkfiyatlbl = guiCreateLabel(25, 233, 331, 19, "● Arazi İlk Fiyatı:", false, mainwindow)
guiSetFont(araziilkfiyatlbl, font0_Font13)
arazioncekifiyatlbl = guiCreateLabel(25, 259, 331, 19, "● Arazi Önceki Fiyatı:", false, mainwindow)
guiSetFont(arazioncekifiyatlbl, font0_Font13)
arazisatisfiyatlbl = guiCreateLabel(25, 288, 331, 19, "● Arazi Satış Fiyatı:", false, mainwindow)
guiSetFont(arazisatisfiyatlbl, font0_Font13)
cizgi3 = guiCreateLabel(10, 313, 454, 19, "——————————————————————————————————————————————————————————————————————————————————————", false, mainwindow)
guiSetFont(cizgi3, font0_Font13)
araziislemlbl = guiCreateLabel(183, 332, 120, 19, "● Arazi İşlemleri ✔ ●", false, mainwindow)
guiSetFont(araziislemlbl, font0_Font13)
cizgi4 = guiCreateLabel(10, 351, 454, 19, "——————————————————————————————————————————————————————————————————————————————————————", false, mainwindow)
guiSetFont(cizgi4, font0_Font13)
arazisonislemtarihilbl = guiCreateLabel(25, 205, 331, 19, "● Arazi Son İşlem Tarihi:", false, mainwindow)
guiSetFont(arazisonislemtarihilbl, font0_Font13)
arazipanelkapabtn = guiCreateButton(35, 385, 113, 44, "Paneli Kapat", false, mainwindow)
guiSetFont(arazipanelkapabtn, font0_Font13)
arazisatinalbtn = guiCreateButton(183, 385, 120, 44, "Satın Al", false, mainwindow)
guiSetFont(arazisatinalbtn, font0_Font13)
araziyonetimpanelbtn = guiCreateButton(332, 385, 113, 44, "Yönetim Paneli", false, mainwindow)
guiSetFont(araziyonetimpanelbtn, font0_Font13)    

Genisliks,Uzunluks = 678,347
Xs = (sGenislik/2) - (Genisliks/2)
Ys = (sUzunluk/2) - (Uzunluks/2)

yonetimwindow = guiCreateWindow(Xs, Ys, Genisliks, Uzunluks, "Arazi Yönetimi", false)
guiWindowSetSizable(yonetimwindow, false)
guiSetVisible(yonetimwindow,false)

arazidekioyuncular = guiCreateGridList(24, 31, 265, 297, false, yonetimwindow)
guiGridListAddColumn(arazidekioyuncular, "Arazindeki Oyuncular", 0.9)
satisacikarbtn= guiCreateButton(500, 58, 141, 45, "Satışa Çıkar", false, yonetimwindow)

miktartxt = guiCreateEdit(324, 68, 155, 31, "", false, yonetimwindow)
araziyidevretbtn = guiCreateButton(328, 130, 141, 45, "Araziyi Devret", false, yonetimwindow)
arazirenkayarlabtn = guiCreateButton(500, 130, 141, 45, "Rengi Ayarla", false, yonetimwindow)
araziswyesatbtn = guiCreateButton(328, 196, 141, 45, "Sunucuya Sat (3)", false, yonetimwindow)
araziiznibtn = guiCreateButton(500, 196, 141, 45, "Araç İzni: Açık", false, yonetimwindow)
araziislembtn = guiCreateButton(328, 258, 313, 45, "Araziyi Ek & Biç ve sat", false, yonetimwindow)
arazikapatbtn = guiCreateButton(642, 20, 25, 25, "X", false, yonetimwindow)
bilgi2 = guiCreateLabel(299, 315, 374, 22, "Herhangi bir işlem yapmadan önce, sistem tanıtım videosunu izleyin.", false, yonetimwindow)    

addEventHandler("onClientGUIClick",root,function()
    if source == arazipanelkapabtn then
        guiSetVisible(mainwindow,false)
        showCursor(false)
    elseif source == arazisatinalbtn then
        if guiGetText(arazidurumlbl) == "● Arazi Durumu: Satılık Değil" then exports.hud:dm("Bu arazi Satışta olmadığı için, satın alamazsın.",255,255,255,true) return end
        local olay = "Satış"
        local oyuncu = "sa"
        triggerServerEvent("AraziSystem:SatisVeDevir",localPlayer,id,olay,oyuncu)
    elseif source == araziyonetimpanelbtn then
        triggerServerEvent("AraziSystem:YonetimKontrol",localPlayer)
        guiSetVisible(mainwindow,false)
        showCursor(false)
    elseif source == arazikapatbtn then
        guiSetVisible(yonetimwindow,false)
        showCursor(false)   
    elseif source == arazirenkayarlabtn then
        local renkkodu = guiGetText(miktartxt)
        triggerServerEvent("AraziSystem:AraziRenkDegis",localPlayer,renkkodu,id)   
    elseif source == araziswyesatbtn then
        text = guiGetText(araziswyesatbtn) 
        if text == "Sunucuya Sat (3)" then
            guiSetText(araziswyesatbtn,"Sunucuya Sat (2)")
            exports.hud:dm("Arazin sunucuya değerinin %45 fiyatına satılacak. Kabul ediyorsan basmaya devam et.",255,255,255,true)
        elseif text == "Sunucuya Sat (2)" then
            guiSetText(araziswyesatbtn,"Sunucuya Sat (1)")
            exports.hud:dm("Arazin sunucuya değerinin %45 fiyatına satılacak. Kabul ediyorsan basmaya devam et.",255,255,255,true)        
        elseif text == "Sunucuya Sat (1)" then
            guiSetText(araziswyesatbtn,"Sunucuya Sat")
            exports.hud:dm("Arazin sunucuya değerinin %45 fiyatına satılacak. Kabul ediyorsan basmaya devam et.",255,255,255,true)   
        elseif text == "Sunucuya Sat" then
            local olay = "SunucuyaSatış"
            triggerServerEvent("AraziSystem:SatisVeDevir",localPlayer,id,olay)
            guiSetText(araziswyesatbtn,"Sunucuya Sat (3)")
        end
    end
end)

addEventHandler("onClientGUIClick",root,function()
    if source == araziyidevretbtn then  
        local devir = "Devir"
        local oyuncu = guiGridListGetItemText(arazidekioyuncular, guiGridListGetSelectedItem(arazidekioyuncular), 1)
        triggerServerEvent("AraziSystem:SatisVeDevir",localPlayer,id,devir,oyuncu)
    elseif source == satisacikarbtn then
        local miktar = guiGetText(miktartxt)
        local olay
        if guiGetText(satisacikarbtn) == "Satışa Çıkar" then olay = "Satış" end
        if guiGetText(satisacikarbtn) == "Satıştan Kaldır" then olay = "Kaldir" end 
        triggerServerEvent("AraziSystem:SatisaCikar",localPlayer,id,miktar,olay)
    elseif source == araziiznibtn then
       if guiGetText(araziiznibtn) == "Araç İzni: Kapalı" then
        triggerServerEvent("AraziSystem:Aracİzni",localPlayer,"ac")
        guiSetText(araziiznibtn,"Araç İzni: Açık")
       elseif guiGetText(araziiznibtn) == "Araç İzni: Açık" then
        triggerServerEvent("AraziSystem:Aracİzni",localPlayer,"kapa")
        guiSetText(araziiznibtn,"Araç İzni: Kapalı")
       end
    elseif source == araziislembtn then
        local text = guiGetText(araziislembtn)
        if text == "Araziye Bina inşaatı talebi" then
            exports.hud:dm("#ffffffArazinize Bina dikmek için, #ff7f00İnşaat Şirketlerine (Sunucu Yönetimine)#ffffff Başvurmalısınız.",255,255,255,true)
        elseif text == "Araziyi Ek & Biç ve sat" then
            triggerServerEvent("AraziSystem:AraziEk",localPlayer,id)
        end
    end
end)

addEvent("AraziSystem:AraziGiris",true)
addEventHandler("AraziSystem:AraziGiris",root,function(veriler,gelenid)
    id = gelenid
    for i,v in pairs(veriler) do 
        if tonumber(id) == tonumber(v["araziid"]) then
            guiSetText(araziidlbl,"● Arazi ID: "..tostring(v.araziid))
            guiSetText(arazidurumlbl, "● Arazi Durumu: "..tostring(v.arazidurum))
            guiSetText(arazisahiplbl, "● Arazi Sahibi: "..tostring(v.arazisahip))
            guiSetText(araziilkfiyatlbl, "● İlk Fiyatı: "..tostring(v.araziilkfiyat))
            guiSetText(arazioncekifiyatlbl, "● Önceki Fiyatı: "..tostring(v.arazioncekif))
            guiSetText(arazisatisfiyatlbl, "● Satış Fiyatı: "..tostring(v.arazifiyat))
            guiSetText(arazisonislemtarihilbl, "● Son İşlem Tarihi: "..tostring(v.araziucret))
            guiSetText(arazirenklbl, "● Arazi Rengi: "..tostring(v.arazirenk))
            guiSetText(araziturlbl, "● Arazi Türü: "..tostring(v.arazitur))
            if tostring(v.araziaracizin) == tostring("true") then
                guiSetText(araziiznibtn,"Araç İzni: Kapalı")
            else
                guiSetText(araziiznibtn,"Araç İzni: Açık")
            end
            if v.arazitur == "Tarım" then
                guiSetText(araziislembtn,"Araziyi Ek & Biç ve sat")
            elseif v.arazitur == "İnşaat" then
                guiSetText(araziislembtn,"Araziye Bina inşaatı talebi")
            end
            if v.arazidurum == "Satışta" then
                guiSetText(satisacikarbtn,"Satıştan Kaldır")
            else
                guiSetText(satisacikarbtn,"Satışa Çıkar")
            end
        end
    end
...
local iki = {
    ...
    {17.17, -40.97, 3.117},
    {41.086, -79.748, 0.609},
    {43.124, -108.593, 0.617},
    {22.69, -115.909, 0.609},
    {-5.971, -111.954, 2.103},
    {18.936, 45.243, 3.117},
    {63.79, 11.434, 0.968},
    {-224.173, -245.497, 1.422},
    }

    local bir = {
        {1920.342, 241.813, 28.989},
        {1950.334, 236.718, 28.436},
        {1982.253, 231.744, 27.719},
        {2001.431, 219.417, 26.857},
        {1996.915, 186.839, 29.606},
        {1976.617, 178.107, 32.778},
        {1943.745, 187.155, 34.659},
        {1921.153, 192.382, 34.653},
        {1917.965, 214.471, 30.482},
        {1917.655, 228.171, 28.896},
        {1903.443, 141.522, 35.436},
        }


    local uc = {
        {-1158.285, -1450.69, 125.036},
        {-1188.68, -1452.433, 120.458},
        {-1212.952, -1453.219, 113.127},
        {-1232.267, -1458.213, 109.317},
        {-1238.042, -1436.133, 109.947},
        {-1238.536, -1407.223, 113.803},
        {-1238.846, -1382.464, 118.341},
        {-1219.341, -1377.943, 119.541},
        {-1217.217, -1399.717, 116.056},
        {-1215.368, -1424.196, 114.658},
        {-1406.192, -1474.075, 101.707},
        }

        local dort = {
            {-1175.651, -928.657, 129.219},
            {-1131.474, -922.092, 129.219},
            {-1073.428, -921.767, 129.219},
            {-1031.507, -922.02, 129.213},
            {-1013.377, -961.585, 129.219},
            {-1014.842, -1022.574, 129.213},
            {-1037.751, -1053.805, 129.219},
            {-1094.298, -1055.271, 129.212},
            {-1161.938, -1055.122, 129.219},
            {-1187.456, -1004.243, 129.219},
            {-1048.341, -1205.759, 128.925},
            }

            local bes = {
                {-318.401, -1424.294, 14.663},
                {-317.781, -1387.505, 12.314},
                {-317.146, -1341.309, 9.023},
                {-298.282, -1319.36, 9.005},
                {-260.943, -1318.766, 9.841},
                {-210.559, -1316.211, 8.587},
                {-183.48, -1356.595, 4.25},
                {-168.394, -1392.108, 3.445},
                {-182.905, -1411.965, 3.021},
                {-239.228, -1415.027, 7.495},
                {-78.653, -1125.789, 1.078},
                }

addEvent("AraziSystem:EkinEk",true)
addEventHandler("AraziSystem:EkinEk",root,function(id)
    tablo = { }
    if id == 2 then
        for i,v in pairs(iki) do
            marker = createMarker(iki[i][1],iki[i][2],iki[i][3]-1,"checkpoint",1.5,255,127,0,0)
            enson = marker
            table.insert(tablo,marker)
            addEventHandler("onClientMarkerHit", marker, ekinmarker)
        end
    end
    if id == 1 then
        for i,v in pairs(bir) do
            marker = createMarker(bir[i][1],bir[i][2],bir[i][3]-1,"checkpoint",1.5,255,127,0,0)
            enson = marker
            table.insert(tablo,marker)
            addEventHandler("onClientMarkerHit", marker, ekinmarker)
        end
    ...
    if id == 3 then
        for i,v in pairs(uc) do
            marker = createMarker(uc[i][1],uc[i][2],uc[i][3]-1,"checkpoint",1.5,255,127,0,0)
            enson = marker
            table.insert(tablo,marker)
            addEventHandler("onClientMarkerHit", marker, ekinmarker)
        end
    ...
    if id == 4 then
        for i,v in pairs(dort) do
            marker = createMarker(dort[i][1],dort[i][2],dort[i][3]-1,"checkpoint",1.5,255,127,0,0)
            enson = marker
            table.insert(tablo,marker)
            addEventHandler("onClientMarkerHit", marker, ekinmarker)
        end
    ...
    if id == 5 then
        for i,v in pairs(bes) do
            marker = createMarker(bes[i][1],bes[i][2],bes[i][3]-1,"checkpoint",1.5,255,127,0,0)
            enson = marker
            table.insert(tablo,marker)
            addEventHandler("onClientMarkerHit", marker, ekinmarker)
        end
...
function ekinmarker(hit)
        sayac = sayac + 1
        if sayac <= 10 then
            destroyElement(source)
        end
        if sayac == 10 then
            exports.hud:dm("Başarıyla Arazini Sürdün! Haritada seçili yere git ve boşalt.",255,255,255,true)
            blip = createBlipAttachedTo(enson, 41)
         end
         if sayac > 10 then
            destroyElement(blip)
            destroyElement(enson)
            setElementData(localPlayer,"AraziSystem:Tarim",false)
            exports.hud:dm("Başarıyla Boşalttın. Bu işlemi 2 günde 1 kez yapabilirsin sadece.",255,255,255,true)
            sayac = 0
            triggerServerEvent("AraziSystem:AraziEkimBitir",localPlayer,id)
         end
end

addEvent("AraziSystem:MarkerSifirla",true)
addEventHandler("AraziSystem:MarkerSifirla",root,function()
        for i,v in pairs(tablo) do
            destroyElement(v)
        end
end)

addEvent("AraziSystem:Guncelle",true)
addEventHandler("AraziSystem:Guncelle",root,function(girenler)
    guiGridListClear(arazidekioyuncular)
    for i,v in pairs(girenler) do
        row = guiGridListAddRow(arazidekioyuncular,v)
    end
end)

addEvent("AraziSystem:YonetimPanelAc",true)
addEventHandler("AraziSystem:YonetimPanelAc",root,function()
    guiSetVisible(yonetimwindow,true)
    showCursor(true)
end)

addEvent("AraziSystem:YonetimPanelKapa",true)
addEventHandler("AraziSystem:YonetimPanelKapa",root,function()
    guiSetVisible(yonetimwindow,false)
    showCursor(false)
end)

addEvent("AraziSystem:MainPanelKapa",true)
addEventHandler("AraziSystem:MainPanelKapa",root,function()
    guiSetVisible(mainwindow,false)
    showCursor(false)
end)

butons = {   
    {"AraziSystem:Tarim", -- data
       {
       ...
       ["F9"] = true, -- iptal edilcek tuş
       ["F10"] = true, -- iptal edilcek tuş	 
       ["o"] = true, -- iptal edilcek tuş	 
       ["b"] = true, -- iptal edilcek tuş	 	
       ["j"] = true, -- iptal edilcek tuş 	
       ["j"] = true, -- iptal edilcek tuş 
       ["n"] = true, -- iptal edilcek tuş 			  
       }  
    },   
 }
 ...
 addEventHandler("onClientKey", root, function(button, press) 
    for i,v in pairs(butons) do 
       ...
       if tus[button] and getElementData(localPlayer, "AraziSystem:Tarim") then 
          cancelEvent()
       end
    end      
 end)